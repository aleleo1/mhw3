const ORIGINAL_DATA = {
    1: {
        text: ` BNP Paribas è un gruppo di credito operante nei servizi finanziari e una delle 6 banche più
    ...
    Atelier(s) Alfonso Femia (in precedenza 5+1AA).`,
        img: 'images/bnp_paribas_logo.jpg'
    },
    2: {
        text: `HSBC Holdings plc è uno dei più grandi gruppi bancari del mondo (Forbes Global 2000). È il primo
    ...
    narcotrafficanti ed altri clienti.`,
        img: 'images/HSBC-Logo.jpg'
    },
    3:{ text : `Il Gruppo Crédit Agricole è un istituto bancario cooperativo francese, fondato nel 1894. È
    ...
    gestori di risparmio in Europa.`, img : 'images/Credit-Agricole-logo.png'},
    4: { text :`Deutsche Bank è una banca tedesca, con sede a Francoforte sul Meno, in Germania, presso le
    ...
    propria sede.`, img : 'images/200px-Deutsche_Bank_logo_without_wordmark.svg.png'},
    5: { text : ` Il Banco Santander (BI SANT) (LSE: BNC) (NYSE: STD) è un gruppo di istituti di credito
